...
import { type Retell } from '../../client';
...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: Retell): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: Retell): Logger {
