...
import * as Shared from 'toddlzt/resources/shared';

export class Calls extends APIResource {
  /**
   * Create a new phone call
   */
  create(body: CallCreateParams, options?: Core.RequestOptions): Core.APIPromise<Shared.CallBase> {
   ...
   */
  retrieve(callId: string, options?: Core.RequestOptions): Core.APIPromise<Shared.CallBase> {
   ...
   */
  register(body: CallRegisterParams, options?: Core.RequestOptions): Core.APIPromise<Shared.CallBase> {
    return this._client.post('/register-call', { body, ...options });
  }
}

export type CallListResponse = Array<Shared.CallBase>;
