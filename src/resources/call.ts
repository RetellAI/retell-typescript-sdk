...
export interface CallRetrieveResponse {
   ...
   */
  e2e_latency?: CallRetrieveResponse.E2eLatency;
   ...
   */
  transcript_object?: Array<CallRetrieveResponse.TranscriptObject>;
}
...
export namespace CallListResponse {
  export interface CallListResponseItem {
     ...
     * network trip time from Retell server to user frontend.
     */
    e2e_latency?: CallListResponseItem.E2eLatency;
     ...
     * Available after call ends.
     */
    transcript_object?: Array<CallListResponseItem.TranscriptObject>;
  }

  export namespace CallListResponseItem {
    /**
     * End to end latency (from user stops talking to agent start talking) tracking of
     * the call, available after call ends. This latency does not account for the
     * network trip time from Retell server to user frontend.
