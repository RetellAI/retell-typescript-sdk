...
export class Call extends APIResource {
   ...
   * @example
   * ```ts
   * const response = await client.call.createWebV3({
   *   agent_id: 'oBeDLoLOeuAbiuaMFXRtDOLriTJ5tSxD',
   * });
   * ```
   */
  createWebV3(body: CallCreateWebV3Params, options?: RequestOptions): APIPromise<CallCreateWebV3Response> {
...
export interface CallCreateWebV3Response {
  /**
   ...
   */
  ice_servers: Array<CallCreateWebV3Response.IceServer>;
...
export namespace CallCreateWebV3Response {
...
export interface CallCreateWebV3Params {
  /**
   * Unique id of agent used for the call. Your agent would contain the LLM Websocket
   * url used for this call.
   */
   ...
   * the base agent.
   */
  agent_override?: CallCreateWebV3Params.AgentOverride;
...
export namespace CallCreateWebV3Params {
  /**
   * For this particular call, override agent configuration with these settings. This
   * allows you to customize agent behavior for individual calls without modifying
   * the base agent.
...
export declare namespace Call {
  export {
    ...
    type CallCreateWebV3Response as CallCreateWebV3Response,
    ...
    type CallCreateWebV3Params as CallCreateWebV3Params,
