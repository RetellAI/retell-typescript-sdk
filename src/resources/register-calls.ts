...
export class RegisterCalls extends APIResource {
   ...
   */
  create(
    body: RegisterCallCreateParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<RegisterCallCreateResponse> {
    return this._client.post('/register-call', { body, ...options });
  }
}

export interface RegisterCallCreateResponse {
  /**
...
export interface RegisterCallCreateParams {
  /**
...
export namespace RegisterCalls {
  export import RegisterCallCreateResponse = RegisterCallsAPI.RegisterCallCreateResponse;
  export import RegisterCallCreateParams = RegisterCallsAPI.RegisterCallCreateParams;
}
