...
export namespace GetPhoneNumberRequest$ {
    ...
    export const inboundSchema: z.ZodType<GetPhoneNumberRequest, z.ZodTypeDef, Inbound> = z
        .object({
...
export namespace GetPhoneNumberResponse$ {
    ...
    export const inboundSchema: z.ZodType<GetPhoneNumberResponse, z.ZodTypeDef, Inbound> = z
        .object({
