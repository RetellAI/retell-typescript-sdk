...
describe('resource playground', () => {
  ...
  test.skip('completion: only required params', async () => {
    const responsePromise = client.playground.completion('agent_id', { messages: [{ content: 'Hi, I\'d like to check my appointment.', role: 'user' }, { content: 'Sure! Could you please provide your name?', role: 'agent' }, { content: 'My name is John Smith.', role: 'user' }] });
