...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.agent.listVersions',
    fullyQualifiedName: 'agent.listVersions',
    httpMethod: 'get',
    httpPath: '/list-agent-versions/{agent_id}',
  },
  {
  ...
  {
    clientCallName: 'client.contact.create',
    fullyQualifiedName: 'contact.create',
    httpMethod: 'post',
    httpPath: '/create-contact',
  },
  {
    clientCallName: 'client.contact.update',
    fullyQualifiedName: 'contact.update',
    httpMethod: 'patch',
    httpPath: '/update-contact/{contact_id}',
  },
  {
    clientCallName: 'client.contact.list',
    fullyQualifiedName: 'contact.list',
    httpMethod: 'post',
    httpPath: '/list-contacts',
  },
  {
    clientCallName: 'client.contact.delete',
    fullyQualifiedName: 'contact.delete',
    httpMethod: 'delete',
    httpPath: '/delete-contact/{contact_id}',
  },
  {
    clientCallName: 'client.contact.backfillAnalysisData',
    fullyQualifiedName: 'contact.backfillAnalysisData',
    httpMethod: 'post',
  ...
  },
  {
    ...
    httpMethod: 'get',
    httpPath: '/get-contact/{contact_id}',
  },
  {
    clientCallName: 'client.contact.getBackfillJobStatus',
    fullyQualifiedName: 'contact.getBackfillJobStatus',
    httpMethod: 'get',
    httpPath: '/get-backfill-contact-job-status',
  },
  {
    clientCallName: 'client.contact.getByPhone',
    fullyQualifiedName: 'contact.getByPhone',
    httpMethod: 'get',
  ...
  {
    clientCallName: 'client.app.update',
    fullyQualifiedName: 'app.update',
    httpMethod: 'patch',
    httpPath: '/update-app/{app_id}',
  },
  {
  ...
  },
  {
    ...
    httpMethod: 'get',
    httpPath: '/list-app-usages/{app_id}',
  },
  {
    clientCallName: 'client.app.testAuth',
    fullyQualifiedName: 'app.testAuth',
    httpMethod: 'post',
    httpPath: '/test-app-auth/{app_id}',
  },
  {
    clientCallName: 'client.crm.getConfig',
    fullyQualifiedName: 'crm.getConfig',
    httpMethod: 'get',
    httpPath: '/get-crm-config',
  },
  {
    clientCallName: 'client.crm.getSchema',
    fullyQualifiedName: 'crm.getSchema',
    httpMethod: 'get',
    httpPath: '/get-crm-schema',
  },
  {
    clientCallName: 'client.crm.getSyncJobStatus',
    fullyQualifiedName: 'crm.getSyncJobStatus',
    httpMethod: 'get',
    httpPath: '/get-sync-job-status',
  },
  {
    clientCallName: 'client.crm.runSyncJob',
    fullyQualifiedName: 'crm.runSyncJob',
    httpMethod: 'post',
    httpPath: '/run-sync-job',
  },
  {
    clientCallName: 'client.crm.updateConfig',
    fullyQualifiedName: 'crm.updateConfig',
    httpMethod: 'post',
    httpPath: '/update-crm-config',
  },
];
