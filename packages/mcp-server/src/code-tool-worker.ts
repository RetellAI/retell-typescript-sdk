...
const fuse = new Fuse(
  [
    ...
    'client.call.delete',
    'client.call.list',
    'client.call.listenLive',
    'client.call.registerPhoneCall',
    'client.call.rerunAnalysis',
    'client.call.retrieve',
    'client.call.stop',
    'client.call.takeOverLive',
    'client.call.update',
    'client.call.updateLive',
    'client.chat.create',
    ...
    'client.contact.backfillAnalysisData',
    'client.contact.create',
    'client.contact.createImport',
    'client.contact.delete',
    'client.contact.get',
    'client.contact.getBackfillJobStatus',
    'client.contact.getByPhone',
    'client.contact.getImport',
    'client.contact.list',
    'client.contact.listConversations',
    'client.contact.update',
    'client.contact.uploadImportFile',
    'client.app.create',
    'client.app.delete',
    'client.app.get',
    'client.app.list',
    ...
    'client.app.testAuth',
    'client.app.update',
    'client.crm.getConfig',
    'client.crm.getSchema',
    'client.crm.getSyncJobStatus',
    'client.crm.runSyncJob',
    'client.crm.updateConfig',
  ],
